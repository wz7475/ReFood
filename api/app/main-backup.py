...
from api.app.utils.logger import get_logger
from api.app.routers.models.shered import Base
from api.app.routers.models.dishes import Dishes, TagsValues
from api.app.routers.models.users import Users, get_user_name, get_user_surname
from api.app.routers.models.offers import Offers, OfferState, read_all_offers, convert_offers, Outbox
from sqlalchemy.sql.functions import current_timestamp
from sqlalchemy import select
from api.app.utils.cfg import ADD_OFFER_QUEUE, DELETE_OFFER_QUEUE, OFFER_INDEX
from api.app.utils.es_tools import get_by_fulltext
from api.app.utils.connectors import get_rabbitmq_connection, get_es_connection
from api.app.utils.sessions import SessionData, backend, cookie, verifier
from api.app.utils.backgroundtasks import send_messages_from_outbox
from uuid import UUID, uuid4

from api.app.utils.sqlalchemy import engine, SessionLocal, get_db
